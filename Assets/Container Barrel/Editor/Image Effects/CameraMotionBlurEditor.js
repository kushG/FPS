...
{	
  ...
  var _previewScale : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    _preview = serObj.FindProperty ("_preview");
    _previewScale = serObj.FindProperty ("_previewScale");
  ...
  function OnInspectorGUI () {         
    ...
    if (_preview.boolValue)
      EditorGUILayout.PropertyField (_previewScale, new GUIContent(" Preview Scale"));    
